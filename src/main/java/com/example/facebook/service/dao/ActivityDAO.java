...
import com.example.facebook.service.interfaces.IActivityDAO;
...
public class ActivityDAO implements IActivityDAO {
    ...
    private static final String select_all_activity = "select a.* from activities a join users u on a.userId = u.userId where u.role = 'User' and (a.type ='like_post' or a.type = 'like_comment' or a.type = 'post' or a.type = 'comment') order by a.createAt desc;";
