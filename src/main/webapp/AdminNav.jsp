...
<div class="row" style="margin: 0 0 10px 0; background-color: #d3d3d373">
    <ul class="nav justify-content-between">
        <li class="nav-item" style="align-content: center">
            <button style="background: none; color: #0d6efd" class="toggle-btn" onclick="togglePanel()">
        ...
        <li class="nav-link">
            <ul class="nav">
                <li class="nav-item" style="align-content: end">
