    ...
    <div class="center">
        ...
        <div class="post-container">
            <c:forEach items="${posts}" var="post">
                <div class="post-card">
                    <div class="introduce" style="display: flex; justify-content: space-around">
                        <div>
                            <img src="${user.image}" style="height: 50px;width: 50px">
                            <div style="display: flex; flex-direction: column">
                                <div style="height: 20px;">
                                    <a style="font-weight: bold; color: black">${user.name}</a>
                                </div>
                                <div>
                        ...
                        <div>
                            <div>
                                <a href="" style="font-size: large">...</a>
                            </div>
                            <div>
                                <a href="">
                    ...
                    <div class="post-information">
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-hand-thumbs-up" viewBox="0 0 10 20">
                        ...
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-chat" viewBox="0 0 10 20">
