            ...
            <div style="padding-block: 10px;" class="row">
                <form class="searchForm" action="/friends?action=searchInFriends" method="post">
                    <div class="input-group mb-3">
                        <input style="border-color: #6c757d" type="text" name="value" class="form-control" placeholder="Tìm kiếm trong danh sách bạn bè..." aria-label="Recipient's username" aria-describedby="button-addon2">
